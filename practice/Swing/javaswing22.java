...
public class javaswing22 extends JFrame{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource() == button1){
				...
				try{
					...
					JOptionPane.showMessageDialog(javaswing22.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
				...
				if(dollarSign.isSelected()) {
					...
					JOptionPane.showMessageDialog(javaswing22.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
				...
				JOptionPane.showMessageDialog(javaswing22.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
